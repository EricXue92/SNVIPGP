...
def main(hparams):
    ...
    # hparams.epochs = wandb.config.epochs
    ...
    if not hparams.sngp:
        parameters.append( {"params": likelihood.parameters() } ) # torch.Size([4, 4])
    ...
    def compute_test_loss_at_last_epoch(trainer):
        ...
        result["auroc"], result["aupr"], result['acc']= auroc, aupr, test_accuracy
        result['loss'], result['ineff'] = test_loss, inefficiency
